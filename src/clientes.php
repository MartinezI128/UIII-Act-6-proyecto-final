    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        if (empty($id)) {
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO cliente(nombre,telefono,direccion,estado,ciudad,cp,correo) values ('$nombre', '$telefono', '$direccion', '$estado', '$ciudad', '$cp', '$correo')");
                if ($query_insert) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE cliente SET nombre = '$nombre' , telefono = '$telefono', direccion = '$direccion', estado = '$estado', ciudad = '$ciudad', cp = '$cp', correo = '$correo' WHERE idcliente = $id");
            if ($sql_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                        Cliente Modificado
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            <div class="col-md-12">
                ...
                <form action="" method="post" autocomplete="off" id="formulario">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="cp" class="text-dark font-weight-bold">Codigo Postal</label>
